...
function LoginForm({}) {
    ...
    const onSubmit = async e => {
        ...
        if (data.status === 1) {
            ...
            history.push(`/profile/${data.login}`)
        }
    };
    ...
    return (
        <div className="auth">
            ...
            <div className="main-page__login__main">
                <div className="main-page__title">ВХОД</div>
                <form action="#" className="registration-form" onSubmit={onSubmit}>
                    <input onChange={(e) => setLogin(e.target.value)} type="text" className="main-page__input"
                           placeholder="логин"/>
                    <input onChange={(e) => setPass(e.target.value)} type="password" className="main-page__input"
                           placeholder="пароль"/>
                    <input type="submit" className="main-page__submit__reg" value="вход"/>
                </form>
            </div>
            <div className="main-page__registration__footer">
                <div className="footer-date">2020</div>
